...
namespace StatTranslator {
    public class EnglishLanguage : ILocalizedLanguage {
        ...
        private readonly Dictionary<string, string> _stats = new Dictionary<string, string> {
            ...
            {"iatag_html_genericstats", "You are seeing this item's base stats.\r\nIt will be updated with the actual stats as you play. See the help tab for more information."},
            ...
            {"iatag_ui_update_item_stats", "Clear cache"},
            ...
            {"iatag_ui_checkupdatesdaily", "Check for updates daily"},
            {"iatag_ui_checkupdatesweekly", "Check for updates weekly"},
            ...
            {"iatag_ui_advancedsettings", "Reconfigure tabs"},
            {"iatag_ui_configmode", "Switch modes"  },
            {"iatag_ui_resetsettings", "Reset settings"},
            {"iatag_ui_resetsettings_title", "Reset settings?"},
            {"iatag_ui_resetsettings_body", "This will delete all your settings and restart Item Assistant.\n\nYou will be logged out of online backups and every setting is restored to its default.\n\nYour items are safe, nothing is deleted from your collection.\n\nAre you sure?"},
